...
import com.konfigthis.client.model.PlaylistTracksRefObject;
...
public class SimplifiedPlaylistObject {
  ...
  **/
   ...
   * @return the SimplifiedPlaylistObject instance itself
   */
  public SimplifiedPlaylistObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, simplifiedPlaylistObject.description) &&
        Objects.equals(this.collaborative, simplifiedPlaylistObject.collaborative) &&
        ...
        Objects.equals(this.additionalProperties, simplifiedPlaylistObject.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, collaborative, externalUrls, href, id, images, name, owner, _public, snapshotId, tracks, type, uri, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SimplifiedPlaylistObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SimplifiedPlaylistObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("tracks") != null && !jsonObj.get("tracks").isJsonNull()) {
        PlaylistTracksRefObject.validateJsonObject(jsonObj.getAsJsonObject("tracks"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SimplifiedPlaylistObject>() {
           ...
           public SimplifiedPlaylistObject read(JsonReader in) throws IOException {
             ...
             SimplifiedPlaylistObject instance = thisAdapter.fromJsonTree(jsonObj);
