...
public class AlbumObject {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The copyright statements of the album. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "[\"Egg punk\",\"Noise rock\"]", required = true, value = "A list of the genres the album is associated with. If not yet classified, the array is empty. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The label associated with the album. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The popularity of the album. The value will be between 0 and 100, with 100 being the most popular. ")
   ...
   * @return the AlbumObject instance itself
   */
  public AlbumObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.albumType, albumObject.albumType) &&
        ...
        Objects.equals(this.additionalProperties, albumObject.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(albumType, totalTracks, availableMarkets, externalUrls, href, id, images, name, releaseDate, releaseDatePrecision, restrictions, type, uri, artists, tracks, copyrights, externalIds, genres, label, popularity, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AlbumObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AlbumObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      // validate the required field `external_ids`
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AlbumObject>() {
           ...
           public AlbumObject read(JsonReader in) throws IOException {
             ...
             AlbumObject instance = thisAdapter.fromJsonTree(jsonObj);
