...
public class ErrorObject {
  ...
  public ErrorObject status(Integer status) {
    if (status != null && status < 400) {
      throw new IllegalArgumentException("Invalid value for status. Must be greater than or equal to 400.");
    }
    if (status != null && status > 599) {
      throw new IllegalArgumentException("Invalid value for status. Must be less than or equal to 599.");
    }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The HTTP status code (also returned in the response header; see [Response Status Codes](/documentation/web-api/concepts/api-calls#response-status-codes) for more information). ")
  ...
  * @throws IOException if the JSON Object is invalid with respect to ErrorObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ErrorObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
