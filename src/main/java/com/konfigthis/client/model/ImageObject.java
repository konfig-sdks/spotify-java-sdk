...
public class ImageObject {
  ...
  **/
   ...
   * @return the ImageObject instance itself
   */
  public ImageObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, imageObject.url) &&
        ...
        Objects.equals(this.additionalProperties, imageObject.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(url, height, width, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ImageObject>() {
           ...
           public ImageObject read(JsonReader in) throws IOException {
             ...
             ImageObject instance = thisAdapter.fromJsonTree(jsonObj);
