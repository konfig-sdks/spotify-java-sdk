...
public class PagingFeaturedPlaylistObject {
  ...
  **/
  ...
  @ApiModelProperty(example = "Popular Playlists", value = "The localized message of a playlist. ")
  ...
  **/
   ...
   * @return the PagingFeaturedPlaylistObject instance itself
   */
  public PagingFeaturedPlaylistObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, pagingFeaturedPlaylistObject.message) &&
        ...
        Objects.equals(this.additionalProperties, pagingFeaturedPlaylistObject.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, playlists, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagingFeaturedPlaylistObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagingFeaturedPlaylistObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PagingFeaturedPlaylistObject>() {
           ...
           public PagingFeaturedPlaylistObject read(JsonReader in) throws IOException {
             ...
             PagingFeaturedPlaylistObject instance = thisAdapter.fromJsonTree(jsonObj);
