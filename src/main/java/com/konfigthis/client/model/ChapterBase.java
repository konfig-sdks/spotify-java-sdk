...
public class ChapterBase {
  ...
  **/
   ...
   * @return the ChapterBase instance itself
   */
  public ChapterBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, chapterBase.description) &&
        Objects.equals(this.audioPreviewUrl, chapterBase.audioPreviewUrl) &&
        ...
        Objects.equals(this.additionalProperties, chapterBase.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChapterBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChapterBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChapterBase is not found in the empty JSON string", ChapterBase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChapterBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChapterBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChapterBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChapterBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChapterBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ChapterBase>() {
           @Override
           public void write(JsonWriter out, ChapterBase value) throws IOException {
           ...
           @Override
           public ChapterBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ChapterBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ChapterBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChapterBase
  * @throws IOException if the JSON string is invalid with respect to ChapterBase
  */
  public static ChapterBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChapterBase.class);
  }

 /**
  * Convert an instance of ChapterBase to an JSON string
  *
  * @return JSON string
  */
