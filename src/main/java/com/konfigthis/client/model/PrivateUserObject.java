...
import com.konfigthis.client.model.ExplicitContentSettingsObject;
...
public class PrivateUserObject {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user's email address, as entered by the user when creating their account. _**Important!** This email address is unverified; there is no proof that it actually belongs to the user._ _This field is only available when the current user has granted access to the [user-read-email](/documentation/web-api/concepts/scopes/#list-of-scopes) scope._ ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user's explicit content settings. _This field is only available when the current user has granted access to the [user-read-private](/documentation/web-api/concepts/scopes/#list-of-scopes) scope._ ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The [Spotify user ID](/documentation/web-api/concepts/spotify-uris-ids) for the user. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user's Spotify subscription level: \"premium\", \"free\", etc. (The subscription level \"open\" can be considered the same as \"free\".) _This field is only available when the current user has granted access to the [user-read-private](/documentation/web-api/concepts/scopes/#list-of-scopes) scope._ ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the user. ")
   ...
   * @return the PrivateUserObject instance itself
   */
  public PrivateUserObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.country, privateUserObject.country) &&
        ...
        Objects.equals(this.additionalProperties, privateUserObject.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(country, displayName, email, explicitContent, externalUrls, followers, href, id, images, product, type, uri, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrivateUserObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrivateUserObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("explicit_content") != null && !jsonObj.get("explicit_content").isJsonNull()) {
        ExplicitContentSettingsObject.validateJsonObject(jsonObj.getAsJsonObject("explicit_content"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PrivateUserObject>() {
           ...
           public PrivateUserObject read(JsonReader in) throws IOException {
             ...
             PrivateUserObject instance = thisAdapter.fromJsonTree(jsonObj);
