...
public class PlaylistOwnerObject {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The [Spotify user ID](/documentation/web-api/concepts/spotify-uris-ids) for this user. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for this user. ")
  ...
  **/
   ...
   * @return the PlaylistOwnerObject instance itself
   */
  public PlaylistOwnerObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.externalUrls, playlistOwnerObject.externalUrls) &&
        ...
        Objects.equals(this.additionalProperties, playlistOwnerObject.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(externalUrls, followers, href, id, type, uri, displayName, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PlaylistOwnerObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PlaylistOwnerObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PlaylistOwnerObject>() {
           ...
           public PlaylistOwnerObject read(JsonReader in) throws IOException {
             ...
             PlaylistOwnerObject instance = thisAdapter.fromJsonTree(jsonObj);
