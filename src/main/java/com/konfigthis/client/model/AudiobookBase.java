...
import com.konfigthis.client.model.AuthorObject;
...
import com.konfigthis.client.model.NarratorObject;
...
public class AudiobookBase {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the audiobook. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the audiobook. ")
  ...
  **/
   ...
   * @return the AudiobookBase instance itself
   */
  public AudiobookBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, audiobookBase.description) &&
        Objects.equals(this.authors, audiobookBase.authors) &&
        ...
        Objects.equals(this.additionalProperties, audiobookBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, authors, availableMarkets, copyrights, htmlDescription, edition, explicit, externalUrls, href, id, images, languages, mediaType, name, narrators, publisher, type, uri, totalChapters, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AudiobookBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AudiobookBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AudiobookBase is not found in the empty JSON string", AudiobookBase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AudiobookBase.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayauthors.size(); i++) {
        AuthorObject.validateJsonObject(jsonArrayauthors.get(i).getAsJsonObject());
      };
      ...
      for (int i = 0; i < jsonArraynarrators.size(); i++) {
        NarratorObject.validateJsonObject(jsonArraynarrators.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AudiobookBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AudiobookBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AudiobookBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AudiobookBase.class));

       return (TypeAdapter<T>) new TypeAdapter<AudiobookBase>() {
           @Override
           public void write(JsonWriter out, AudiobookBase value) throws IOException {
           ...
           @Override
           public AudiobookBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AudiobookBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AudiobookBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AudiobookBase
  * @throws IOException if the JSON string is invalid with respect to AudiobookBase
  */
  public static AudiobookBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AudiobookBase.class);
  }

 /**
  * Convert an instance of AudiobookBase to an JSON string
  *
  * @return JSON string
  */
