...
public class PagingSimplifiedChapterObject {
  ...
  private List<SimplifiedChapterObject> items = new ArrayList<>();
  ...
  **/
   ...
   * @return the PagingSimplifiedChapterObject instance itself
   */
  public PagingSimplifiedChapterObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.href, pagingSimplifiedChapterObject.href) &&
        ...
        Objects.equals(this.additionalProperties, pagingSimplifiedChapterObject.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagingSimplifiedChapterObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagingSimplifiedChapterObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagingSimplifiedChapterObject is not found in the empty JSON string", PagingSimplifiedChapterObject.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagingSimplifiedChapterObject.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagingSimplifiedChapterObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagingSimplifiedChapterObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagingSimplifiedChapterObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagingSimplifiedChapterObject.class));

       return (TypeAdapter<T>) new TypeAdapter<PagingSimplifiedChapterObject>() {
           @Override
           public void write(JsonWriter out, PagingSimplifiedChapterObject value) throws IOException {
           ...
           @Override
           public PagingSimplifiedChapterObject read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagingSimplifiedChapterObject instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagingSimplifiedChapterObject given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagingSimplifiedChapterObject
  * @throws IOException if the JSON string is invalid with respect to PagingSimplifiedChapterObject
  */
  public static PagingSimplifiedChapterObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagingSimplifiedChapterObject.class);
  }

 /**
  * Convert an instance of PagingSimplifiedChapterObject to an JSON string
  *
  * @return JSON string
  */
