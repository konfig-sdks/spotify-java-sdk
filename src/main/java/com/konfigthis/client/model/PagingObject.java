...
public class PagingObject {
  ...
  **/
   ...
   * @return the PagingObject instance itself
   */
  public PagingObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.href, pagingObject.href) &&
        ...
        Objects.equals(this.additionalProperties, pagingObject.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(href, limit, next, offset, previous, total, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagingObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagingObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagingObject is not found in the empty JSON string", PagingObject.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagingObject.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagingObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagingObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagingObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagingObject.class));

       return (TypeAdapter<T>) new TypeAdapter<PagingObject>() {
           @Override
           public void write(JsonWriter out, PagingObject value) throws IOException {
           ...
           @Override
           public PagingObject read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagingObject instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagingObject given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagingObject
  * @throws IOException if the JSON string is invalid with respect to PagingObject
  */
  public static PagingObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagingObject.class);
  }

 /**
  * Convert an instance of PagingObject to an JSON string
  *
  * @return JSON string
  */
