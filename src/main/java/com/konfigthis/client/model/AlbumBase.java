...
public class AlbumBase {
  ...
  **/
   ...
   * @return the AlbumBase instance itself
   */
  public AlbumBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.albumType, albumBase.albumType) &&
        ...
        Objects.equals(this.additionalProperties, albumBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(albumType, totalTracks, availableMarkets, externalUrls, href, id, images, name, releaseDate, releaseDatePrecision, restrictions, type, uri, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AlbumBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AlbumBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AlbumBase>() {
           ...
           public AlbumBase read(JsonReader in) throws IOException {
             ...
             AlbumBase instance = thisAdapter.fromJsonTree(jsonObj);
